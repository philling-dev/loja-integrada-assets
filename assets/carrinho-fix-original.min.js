...
style.innerHTML = "/* Corrigir carrinho Plugoo */ span.titulo.cor-secundaria.vazio-text { display: none !important; } .carrinho-link, .cart-icon, .header-cart { display: block !important; visibility: visible !important; } .cart-counter, .carrinho-contador { display: inline-block !important; min-width: 20px; text-align: center; } .cart-counter:empty::after { content: \"0\"; }";
